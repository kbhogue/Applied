...
DISTDIR = /home/kat/Applied/birthdays/.tmp/birthdays1.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		birthdays.pro database.h \
		record.h database.cpp \
		main.cpp \
		record.cpp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents database.h record.h $(DISTDIR)/
	$(COPY_FILE) --parents database.cpp main.cpp record.cpp $(DISTDIR)/
